...
**Difficulty:** Hard  
[View on LeetCode](https://leetcode.com/problems/minimum-threshold-path-with-limited-heavy-edges/)
...
​​​​​​​![image](https://assets.leetcode.com/uploads/2025/10/13/g6.png)
...
A valid path is `0 &rarr; 1 &rarr; 4 &rarr; 3`. It uses only 1 heavy edge (`[0, 1, 5]`), which satisfies the limit `k = 1`.

Any smaller `threshold` would make it impossible to reach node 3 without exceeding 1 heavy edge.

**Example 2:**

![image](https://assets.leetcode.com/uploads/2025/10/12/g3_f.png)
...
**![image](https://assets.leetcode.com/uploads/2025/10/12/g5.png)**
